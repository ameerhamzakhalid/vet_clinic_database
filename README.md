...
```sh
  cd my-folder
  git clone https://github.com/ameerhamzakhalid/vet_clinic_database.git
```
...
Feel free to check the [issues page](https://github.com/ameerhamzakhalid/vet_clinic_database/issues).
...
This project is [MIT](https://github.com/ameerhamzakhalid/vet_clinic_database/blob/dev/LICENSE) licensed.
